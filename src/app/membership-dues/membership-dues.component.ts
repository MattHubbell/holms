    ...
    resetForm() {
        ...
        this.subscription.push(this.transactionCodeService.list
            .subscribe(x => {
                ...
                this.foundation = x.filter(x => x.itemType == TransactionCodeItemTypes.Foundation)[0].description;
                this.museumLibary = x.filter(x => x.itemType == TransactionCodeItemTypes.MuseumLibary)[0].description;
                this.scholarshipFund = x.filter(x => x.itemType == TransactionCodeItemTypes.ScholarshipFund)[0].description;
            })
        );
