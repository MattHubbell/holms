...
export abstract class FirebaseBaseData extends Subject<FirebaseItem[]> implements FirebaseData {
    ...
    protected processResults(matches: string[], term: string): FirebaseItem[] {
        let i: number;
